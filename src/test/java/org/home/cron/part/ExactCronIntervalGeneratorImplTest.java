...
class ExactCronIntervalGeneratorImplTest {
    private ExactCronIntervalGeneratorImpl cronIntervalGenerator;

    @BeforeEach
    void setUp() {
        cronIntervalGenerator = new ExactCronIntervalGeneratorImpl();
    }
