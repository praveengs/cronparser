...
class EveryNCronIntervalGeneratorImplTest {
    private EveryNCronIntervalGeneratorImpl cronIntervalGenerator;

    @BeforeEach
    void setUp() {
        cronIntervalGenerator = new EveryNCronIntervalGeneratorImpl();
    }
